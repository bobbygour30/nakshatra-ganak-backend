...
const { verifyRazorpayPayment } = require('./kundliPaymantRoutes');
...
console.log('Mode    : PDF WITH 10 MIN WHATSAPP DELAY');
console.log('=================================');
...
// ============================================================
// GENERATE PDF + SCHEDULE WHATSAPP AFTER 10 MINUTES
// ============================================================
  ...
  try {
    ...
    if (
      ...
      return res.status(402).json({
        success: false,
        message:
          'Payment details are required to generate the Kundli PDF'
      });
    }
    ...
    const existing = await ScheduledPdf.findOne({
    ...
    // ========================================================
    // PREPARE ASTROLOGY API PDF REQUEST
    // ========================================================
    ...
    console.log('==========================================');
    console.log('📤 SENDING PDF REQUEST TO ASTROLOGY API');
    console.log('==========================================');
    ...
    console.log('==========================================');
    console.log('🎉 KUNDLI PROCESS COMPLETED');
    console.log('==========================================');
    ...
    return res.json({
      ...
      message:
        'PDF generated! WhatsApp will be sent in 10 minutes',
    ...
    console.error('==========================================');
    console.error('❌ GENERATE-AND-SCHEDULE ERROR');
    console.error('==========================================');
    ...
    if (
      ...
      return res.status(504).json({
        ...
        message:
          'AstrologyAPI request timed out. Please try again.'
      });
    }
    ...
    return res.status(502).json({
      ...
      message:
        error?.response?.data?.message ||
        'Failed to generate PDF from AstrologyAPI',
  ...
  try {
    ...
    if (
      ...
      return res.status(504).json({
        ...
        message:
          'AstrologyAPI request timed out'
      });
    }
...
// ============================================================
// GET SCHEDULED PDF / WHATSAPP STATUS
// ============================================================
